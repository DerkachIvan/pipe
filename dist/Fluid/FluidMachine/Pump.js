...
class Pump extends GameObject {
    ...
    Rotate() {
        if (this.pumpDirection === "up")
            this.pumpDirection = "right";
        else if (this.pumpDirection === "right")
            this.pumpDirection = "down";
        else if (this.pumpDirection === "down")
            this.pumpDirection = "left";
        else if (this.pumpDirection === "left")
            this.pumpDirection = "up";
    }
    static loadSprites() {
        const spriteNames = [
            "U", "D", "L", "R"
    ...
    getSpriteKey() {
        ...
        if (this.pumpDirection === "up")
            key += "U";
        if (this.pumpDirection === "down")
            key += "D";
        if (this.pumpDirection === "left")
            key += "L";
        if (this.pumpDirection === "right")
            key += "R";
        return key;
    }
    Draw() {
